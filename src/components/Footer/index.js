...
function Footer() {
	return (
		<>
			<footer className="w-100 tc-l bg-center cover bg-black fixed bottom-0">
				<div className="w-100 ph3 pv1 bg-black-80 flex justify-center items-center">
					<a
				...
				<p className="f6 ml3 pr2 white mb3 tc">
